...
exports.run = function(client, message, args) {
  ...
  .setColor("GREEN")
  .setDescription(`<a:tik2:810223714758426704> <@${sahip}> adlı kişinin <@${botisim}> adlı botu onaylandı.\nOnaylayan yetkili : ${message.author}`)
  ...
  message.channel.send(`<a:tik2:810223714758426704> Botu onayladınız.`).then(msg => msg.delete(1000))
