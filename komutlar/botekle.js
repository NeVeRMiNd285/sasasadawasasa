...
exports.run = function(client, message, args) {
  ...
  .setColor("PURPLE")
  .setDescription(`<a:tik:807285568966230066> ${message.author} adlı kullanıcının <@${botid}> adlı botu sıraya ekledi. Botu onaylanmayı bekliyor. `)
  ...
  message.channel.send(` <a:tik:807285568966230066> Bot ekleme isteğiniz alındı.`).then(msg => msg.delete(1000))
  }
};
////fiber botlist & code
exports.conf = {
